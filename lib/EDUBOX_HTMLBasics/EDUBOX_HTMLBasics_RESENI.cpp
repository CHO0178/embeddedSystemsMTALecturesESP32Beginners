...
#include <WebServer.h>
#include "EDUBOX_HTMLBasics_page_RESENI.hpp"
...
void example_handlerRoot_HTMLBasics() {
    String page = FPSTR(RES_EXAMPLE_HTML_BASICS_HTML);
...
void exercise_text_handlerRoot_HTMLBasics() {
    String page = FPSTR(RES_EXERCISE_TEXT_HTML_BASICS_HTML);
    server_HTML_Basics.send(200, "text/html; charset=utf-8", page);
}
...
void exercise_style_handlerRoot_HTMLBasics() {
    String page = FPSTR(RES_EXERCISE_STYLE_HTML_BASICS_HTML);
    server_HTML_Basics.send(200, "text/html; charset=utf-8", page);
}
...
void exercise_button_handlerRoot_HTMLBasics() {
    String page = FPSTR(RES_EXERCISE_BUTTON_HTML_BASICS_HTML);
    server_HTML_Basics.send(200, "text/html; charset=utf-8", page);
}
